    ...
    <nav class="navbar navbar-expand-sm fixed-top">
      ...
      <div class="wrap-log collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="login navbar-nav ms-auto">
          <a class="nav-link active fw-bold" aria-current="page" href="dashboard/login.php">
            <img class="mb-1" src="./atribut/icon_log.png" height="25rem" />Log In
          </a>
          <a class="nav-link active fw-bold" href="#">
            <img class="mb-1" src="./atribut/icon_about.png" aria-current="page" height="25rem" />
            Hubungi Kami</a>
        </div>
      </div>
    </nav>
        ...
        <div class="img-slide col-6">
          <div class="slide-btn">
            <div class="slide-carousel">
              <button type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide-to="0" aria-label="Slide 1">
